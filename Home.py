...
my_db = sql.connect(host="127.0.0.1",user="root",password="kanis0111",database="phonepe")

mycursor = my_db.cursor(buffered=True)

# setting the page configuration

icon = Image.open('phonepepulse.png')
...
if selected == "Transactions-Insights":
    with st.container():
        ...
        st.markdown("TRANSACTIONS INSIGHTS")
